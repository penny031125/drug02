!function(n, t) {
    ...
    function l(n, t, r) {
        ...
        if (arguments.length > 1) {
            ...
            for (var h = 0, p = n.arcs.length; h < p; ++h)
                f.push(h);
        return {
            ...
            arcs: u.map(function(t) {
                ...
                if (t.forEach(function(n) {
                    ...
                    for (var u, f, c = 1, s = e(i[0]); c < r; ++c)
                        (u = e(i[c])) > s && (f = i[0], i[0] = i[c], i[c] = f, s = u);
                return i
            })
        }
    }
    ...
    function m() {
        ...
        function t(n, t) {
            for (;;) {
                var r = t + 1 << 1,
                    ...
                    u = t,
                    f = e[u];
                if (i < o && y(e[i], f) < 0 && (f = e[u = i]), r < o && y(e[r], f) < 0 && (f = e[u = r]), u === t)
                    break;
        ...
        return r.push = function(t) {
            ...
            var i,
                u = r._;
            if (e[u] === r)
                return u !== --o && (i = e[o], (y(i, r) < 0 ? n : t)(e[i._ = u] = i, u)), u
        }, r
    }
    function E(n, t) {
        function o(n) {
